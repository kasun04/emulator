...
public class HttpServerBuilde extends AbstractEmulatorContext {
    ...
    public HttpServerBuilde(HTTPProtocolEmulator httpProtocolEmulator) {
        this.httpProtocolEmulator = httpProtocolEmulator;
        this.httpVersion = HttpVersion.HTTP_1_1;
    }

    public HttpServerBuilde host(String host) {
        super.host(host);
        return this;
    }

    public HttpServerBuilde port(int port) {
        super.port(port);
        return this;
    }

    public HttpServerBuilde context(String context) {
        this.context = context;
        return this;
    }

    public HttpServerBuilde readingDelay(int readingDelay) {
        this.readingDelay = readingDelay;
        return this;
    }

    public HttpServerBuilde writingDelay(int writingDelay) {
        this.writingDelay = writingDelay;
        return this;
    }

    public HttpServerBuilde randomConnectionClose(boolean randomConnectionClose) {
        this.randomConnectionClose = randomConnectionClose;
        return this;
    }

    public HttpServerBuilde httpVersion(HttpVersion httpVersion) {
        this.httpVersion = httpVersion;
        return this;
    }

    public HttpServerBuilde when(IncomingMessage incoming) {
        this.incoming = incoming;
        this.incoming.buildPathRegex(context);
        return this;
    }

    public HttpServerBuilde logic(ChannelInboundHandlerAdapter logicHandler) {
        this.logicHandler = logicHandler;
        return this;
    }

    public HttpServerBuilde respond(OutgoingMessage outgoing) {
