...
public class HttpClientBuilder extends AbstractEmulatorContext {
    ...
    public HttpClientBuilder(HTTPProtocolEmulator httpProtocolEmulator) {
    ...
    public HttpClientBuilder when(IncomingMessage incoming) {
        this.incoming = incoming;
        return this;
    }

    public HttpClientBuilder respond(OutgoingMessage outgoing) {
